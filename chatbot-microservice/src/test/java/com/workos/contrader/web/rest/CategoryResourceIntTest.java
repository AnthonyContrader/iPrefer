...
import com.workos.contrader.repository.CategoryRepository;
import com.workos.contrader.service.CategoryService;
import com.workos.contrader.service.dto.CategoryDTO;
import com.workos.contrader.service.mapper.CategoryMapper;
...
public class CategoryResourceIntTest {
    ...
    private static final String DEFAULT_CAT_HELP_MESSAGE = "AAAAAAAAAA";
    private static final String UPDATED_CAT_HELP_MESSAGE = "BBBBBBBBBB";
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category()
            ...
            .catHelpMessage(DEFAULT_CAT_HELP_MESSAGE);
        return category;
    }
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getCatHelpMessage()).isEqualTo(DEFAULT_CAT_HELP_MESSAGE);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].catHelpMessage").value(hasItem(DEFAULT_CAT_HELP_MESSAGE.toString())));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.catHelpMessage").value(DEFAULT_CAT_HELP_MESSAGE.toString()));
    }
    @Test
    @Transactional
    ...
    public void updateCategory() throws Exception {
        ...
        updatedCategory
            ...
            .catHelpMessage(UPDATED_CAT_HELP_MESSAGE);
        ...
        assertThat(testCategory.getCatHelpMessage()).isEqualTo(UPDATED_CAT_HELP_MESSAGE);
    }
