...
import { EventUpdateComponent } from 'app/entities/chatbot/event/event-update.component';
import { EventService } from 'app/entities/chatbot/event/event.service';
import { Event } from 'app/shared/model/chatbot/event.model';
