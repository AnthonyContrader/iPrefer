...
CREATE TABLE `bevanda` (
  ...
  `nome_bevanda` varchar(20) COLLATE utf8mb4_roman_ci DEFAULT NULL,
  `costo_bevanda` float DEFAULT NULL,
  `alcolico` tinyint DEFAULT NULL,
  `descrizione_bevanda` varchar(60) COLLATE utf8mb4_roman_ci DEFAULT NULL,
