...
CREATE TABLE `ordinazione` (
  ...
  CONSTRAINT `id_bevanda` FOREIGN KEY (`id_ordinazione`) REFERENCES `bevanda` (`id_bevanda`),
  CONSTRAINT `id_cliente` FOREIGN KEY (`id_ordinazione`) REFERENCES `cliente` (`id_cliente`),
  CONSTRAINT `id_piatto` FOREIGN KEY (`id_ordinazione`) REFERENCES `piatto` (`id_piatto`)
