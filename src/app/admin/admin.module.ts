 ...
 */
@NgModule({
  declarations: [AdminDashboardComponent, UsersComponent, WorkInProgressComponent, BevandeComponent, PiattiComponent, ClientiComponent, OrdinazioniComponent ,PrenotazioniComponent, RecensioniComponent],
  imports: [
    CommonModule,
    AdminRoutingModule,
    FormsModule
